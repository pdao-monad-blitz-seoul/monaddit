...
contract ScaffoldETHDeploy is Script {
    ...
    function _startBroadcast() internal returns (address) {
        ...
        if (block.chainid == 31337 && _deployer.balance == 0) {
            // Directly call anvil_setBalance without using this
            anvil_setBalance(_deployer, ANVIL_BASE_BALANCE);
    ...
    function anvil_setBalance(address addr, uint256 amount) internal {
